...
HubbaClient.prototype.emit = function() { this._checkSocketMethods('emit'); this._req.io.emit.apply(this._req.io,arguments); return this; };
HubbaClient.prototype.respond = function() { this._checkSocketMethods('respond'); this._req.io.respond.apply(this._req.io,arguments); return this; };
HubbaClient.prototype.broadcast = function() { this._req.io.broadcast.apply(this._req.io,arguments); return this; };
HubbaClient.prototype.broadcastAll = function() { this._server.io.broadcast.apply(this._server.io,arguments); return this; };
HubbaClient.prototype.join = function() { this._checkSocketMethods('join'); this._req.io.join.apply(this._req.io,arguments); return this; };
HubbaClient.prototype.leave = function() { this._checkSocketMethods('leave'); this._req.io.leave.apply(this._req.io,arguments); return this; };
HubbaClient.prototype.room = function() { this._checkSocketMethods('room'); this._req.io.room.apply(this._req.io,arguments); return this; };
