        ...
        ResourceTypeFunction = function(cfg){
            ...
            if (ResourceType.GET){
                this.http.GET = function(req,res){
                    ResourceType.GET(self.toJSON({internal:true}),req,res);
                }
            }

            if (ResourceType.POST){
                this.http.POST = function(req,res){
                    ResourceType.POST(self.toJSON({internal:true}),req,res);
                }
            }

            if (ResourceType.PUT){
                this.http.PUT = function(req,res){
                    ResourceType.PUT(self.toJSON({internal:true}),req,res);
                }
            }

            if (ResourceType.PATCH){
                this.http.PATCH = function(req,res){
                    ResourceType.PATCH(self.toJSON({internal:true}),req,res);
                }
            }

            if (ResourceType.DELETE){
                this.http.DELETE = function(req,res){
                    ResourceType.DELETE(self.toJSON({internal:true}),req,res);
                }
            }
