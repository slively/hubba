...
var assert = require('assert-plus'),
    ...
    SocketList = require('./socket/socketList').SocketList,
    FileList = require('./file/fileList').FileList,
...
function main(argv){
    ...
    sockets.on('init', function(sList) {
    ...
    sockets.on('update', function(s) {
        socketRouter.updateRoute(s);
    });

    sockets.on('remove', function(s) {
        socketRouter.removeRoute(s);
    });

    server.get('/hubba/api/sockets', function(req,res){
        sockets.findAll(function socketsResponseFunction(err,result){
            if (err){
                res.send(400,{
                    message: err.message,
                    stack: err.stack
    ...
    server.get('/hubba/api/sockets/:name', function(req,res){
        sockets.find(req.params.name, function socketsResponseFunction(err,result){
            if (err){
                res.send(400,{
                    message: err.message,
                    stack: err.stack
    ...
    server.post('/hubba/api/sockets', function(req,res){
        sockets.add(req.body, function socketsResponseFunction(err,result){
            if (err){
                res.send(400,{
                    message: err.message,
                    stack: err.stack
    ...
    server.put('/hubba/api/sockets/:name', function(req,res){
        sockets.update(req.params.name, req.body, function socketsResponseFunction(err,result){
            if (err){
                res.send(400,{
                    message: err.message,
                    stack: err.stack
    ...
    server.patch('/hubba/api/sockets/:name', function(req,res){
        sockets.update(req.params.name, req.body, function socketsResponseFunction(err,result){
            if (err){
                res.send(400,{
                    message: err.message,
    ...
    server.del('/hubba/api/sockets/:name', function(req,res){
        sockets.remove(req.params.name, function socketsResponseFunction(err,result){
            if (err){
                res.send(400,{
                    message: err.message,
                    stack: err.stack
    ...
    server.get('/hubba/api/files', function(req,res){

        if (req.query.tree) {
            files.findAllAsTree(function (err,result){
                if (err){
                    res.send(400,{
                        message: err.message,
                        stack: err.stack
            ...
            files.findAll(function (err,result){
                if (err){
                    res.send(400,{
                        message: err.message,
                        stack: err.stack
    ...
    server.get('/hubba/api/files/:id', function(req,res){
        files.find(req.params.id, function (err,result){
            if (err){
                res.send(400,{
                    message: err.message,
                    stack: err.stack
    ...
    server.post('/hubba/api/files', function(req,res){
        files.add(req.body, function (err,result){
            if (err){
                res.send(400,{
                    message: err.message,
                    stack: err.stack
    ...
    server.put('/hubba/api/files/:id', function(req,res){
        files.update(req.params.id, req.body, function (err,result){
            if (err){
                res.send(400,{
                    message: err.message,
                    stack: err.stack
    ...
    server.patch('/hubba/api/files/:id', function(req,res){
        files.update(req.params.id, req.body, function (err,result){
            if (err){
                res.send(400,{
                    message: err.message,
    ...
    server.del('/hubba/api/files/:id', function(req,res){
        files.remove(req.params.id, function (err){
            if (err){
                res.send(400,{
                    message: err.message,
                    stack: err.stack
