...
function main(argv){
    ...
    var server = restify.createServer(),
        ...
        clientStaticServer = restify.serveStatic({
            directory: __dirname+'/externalClients'
        }),
    ...
    server.get('/hubba/clients(.*)',clientStaticServer);
...
function updateSeverRoute(Server, o,internalClient){
    ...
    Server.post({
        ...
        try {
            o.http.POST(req,res,internalClient);
        } catch(err){
            console.log('POST error: ' + err + ':\n' + err.stack + '\n' + 'Params: ' + JSON.stringify(req.params) + '\n' + 'Body: ' + JSON.stringify(req.body) + '\n\n');
            if(!res.headersSent){
                res.send(500,err);
    ...
    Server.put({
        ...
        try {
            o.http.PUT(req,res,internalClient);
        } catch(err){
            console.log('PUT error: ' + err + ':\n' + err.stack + '\n' + 'Params: ' + JSON.stringify(req.params) + '\n' + 'Body: ' + JSON.stringify(req.body) + '\n\n');
            if(!res.headersSent){
                res.send(500,err);
    ...
    Server.patch({
        ...
        try {
            o.http.PATCH(req,res,internalClient);
        } catch(err){
            console.log('PATCH error: ' + err + ':\n' + err.stack + '\n' + 'Params: ' + JSON.stringify(req.params) + '\n' + 'Body: ' + JSON.stringify(req.body) + '\n\n');
            if(!res.headersSent){
                res.send(500,err);
    ...
    Server.del({
        ...
        try {
            o.http.DELETE(req,res,internalClient);
        } catch(err){
            console.log('DELETE error: ' + err + ':\n' + err.stack + '\n' + 'Params: ' + JSON.stringify(req.params) + '\n' + 'Body: ' + JSON.stringify(req.body) + '\n\n');
            if(!res.headersSent){
                res.send(500,err);
