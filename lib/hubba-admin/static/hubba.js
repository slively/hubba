...
app.config(['$routeProvider', '$locationProvider', function($routeProvider, $locationProvider) {
    ...
    var servicesRoute = { templateUrl: '/hubba-admin/partials/services.html', controller: 'serviceCtrl' },
        ...
        testsRoute = { templateUrl: '/hubba-admin/partials/tests.html', controller: 'testCtrl' },
    ...
    $routeProvider
        ...
        .when('/hubba-admin/tests', testsRoute)
        .when('/hubba-admin/tests/:id', testsRoute)
...
app.factory('hubba',['$http','$rootScope','$location', '$window', function($http,$rootScope,$location,$window) {
    var hubba = {};
     ...
     * Me
     */
    function assignAuthToken(){
        if ($window.sessionStorage && $window.sessionStorage.accessToken) {
    ...
    hubba.login = function(o) {
        ...
        return $http.post('/hubba/api/login',o).success(function(me){
            ...
            $window.sessionStorage.accessToken = me.token;
            assignAuthToken();
            delete me.token;
            hubba.me = me;
        }).error(function(){
    ...
    **/
    ...
    hubba.tests = {};
    hubba.tests.cache = [];
    hubba.tests.hasFetched = false;

    function refreshTestsCache(testsList) {
        hubba.tests.cache = testsList;
        hubba.tests.hasFetched = true;
    }

    function addTestToCache(test) {
        hubba.tests.cache.push(test);
    }

    hubba.tests.get = function(o, s, e){
        if (typeof o == "string" || typeof o == "number"){
            return $http.get('/hubba/api/tests/'+o).success(checkUndefinedFunc(s)).error(ef).error(checkUndefinedFunc(e));
        } else {
            if (typeof o == "function"){
                e = s;
                s = o;
                return $http.get('/hubba/api/tests').success(refreshTestsCache).success(checkUndefinedFunc(s)).error(ef).error(checkUndefinedFunc(e));
            } else {
                return $http.get('/hubba/api/tests',{params:o}).success(refreshTestsCache).success(checkUndefinedFunc(s)).error(ef).error(checkUndefinedFunc(e));
            }
        }
    };
    hubba.tests.put = function(o, s, e) {
        return $http.put('/hubba/api/tests/'+ o.id,o).success(checkUndefinedFunc(s)).error(ef).error(checkUndefinedFunc(e));
    };
    hubba.tests.patch = function(o, s, e){
        return $http.patch('/hubba/api/tests/'+ o.id,o).success(checkUndefinedFunc(s)).error(ef).error(checkUndefinedFunc(e));
    };
    hubba.tests.post = function(o, s, e){
        return $http.post('/hubba/api/tests',o).success(addTestToCache).success(checkUndefinedFunc(s)).error(ef).error(checkUndefinedFunc(e));
    };
    hubba.tests.del = function (id, s, e){
        return $http.delete('/hubba/api/tests/'+id).success(checkUndefinedFunc(s)).error(ef).error(checkUndefinedFunc(e));
    };
    ...
    hubba.serverConfigs = {};
    hubba.serverConfigs.cache = [];
    hubba.serverConfigs.hasFetched = false;

    function refreshserverConfigsCache(serverConfigsList) {
        hubba.serverConfigs.cache = serverConfigsList;
        hubba.serverConfigs.hasFetched = true;
    }

    function addToCache(a) {
        hubba.serverConfigs.cache[a.key] = a.value;
    }

    hubba.serverConfigs.get = function(o, s, e){
        if (typeof o == "string" || typeof o == "number"){
            return $http.get('/hubba/api/server_configurations/'+o).success(addToCache).success(checkUndefinedFunc(s)).error(ef).error(checkUndefinedFunc(e));
        } else {
            if (typeof o == "function"){
                e = s;
                s = o;
                return $http.get('/hubba/api/server_configurations').success(refreshserverConfigsCache).success(checkUndefinedFunc(s)).error(ef).error(checkUndefinedFunc(e));
            } else {
                return $http.get('/hubba/api/server_configurations',{params:o}).success(refreshserverConfigsCache).success(checkUndefinedFunc(s)).error(ef).error(checkUndefinedFunc(e));
            }
        }
    };
    hubba.serverConfigs.put = function(o, s, e) {
        return $http.put('/hubba/api/server_configurations/'+ o.key,o).success(addToCache).success(checkUndefinedFunc(s)).error(ef).error(checkUndefinedFunc(e));
    };
    hubba.serverConfigs.patch = function(o, s, e){
        return $http.patch('/hubba/api/server_configurations/'+ o.key,o).success(addToCache).success(checkUndefinedFunc(s)).error(ef).error(checkUndefinedFunc(e));
    };
    hubba.serverConfigs.post = function(o, s, e){
        return $http.post('/hubba/api/server_configurations',o).success(addToCache).success(checkUndefinedFunc(s)).error(ef).error(checkUndefinedFunc(e));
    };
    hubba.serverConfigs.del = function (id, s, e){
        return $http.delete('/hubba/api/server_configurations/'+id).success(checkUndefinedFunc(s)).error(ef).error(checkUndefinedFunc(e));
    };
...
app.controller('testCtrl',['$scope', 'hubba', function($scope, hubba) {
    if (!hubba.tests.hasFetched) {
        hubba.tests.get();
    }

    $.updateTestHeaderKey = function(test, key) {
        test.req.headers
    }
}]);
...
app.controller('serverConfigsCtrl',['$scope', 'hubba', '$timeout', function($, hubba, $timeout){
    var autoSaveTimeout;
    $.serverConfigsSaving = false;
    if (hubba.serverConfigs.hasFetched === false) {
        hubba.serverConfigs.get();
    }

    $.serverConfigsAutoSave = function(key,value){
        $.serverConfigsSaving = key;
        if (autoSaveTimeout){
            $timeout.cancel(autoSaveTimeout);
            autoSaveTimeout = undefined;
        }
        autoSaveTimeout = $timeout(function() {
            $.serverConfigsSave({key:key,value:value});
        },800);
    };
    $.serverConfigsSave = function(config){
        hubba.serverConfigs.put(config).success(function(){
            $.serverConfigsSaving = false;
        }).error(function(){
            $.serverConfigsSaving = false;
        });
...
app.controller('mapCtrl',['$scope','hubba',function($, hubba){
    ...
    var childrenFinder = function childrenFinderDef(item,text,type,asTree) {
        ...
        getServiceChildren = function (service,asTree) {
            ...
            _.each(service.configuration,function(item){
                var configItem = '' + item;
